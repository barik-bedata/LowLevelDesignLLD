...
1. **Left Only (শুধুমাত্র বামে)**: যে কলামগুলো শুধুমাত্র চিহ্নের বাম পাশে (Left hand side) আছে, কিন্তু কোনোটির ডান পাশে নেই। 
...
* 💡 **সহজ ভাষায় BCNF বোঝার গাইড (Why BCNF exists & How it differs from 3NF)**:
  ...
  ৩NF-এর শর্তে বলা আছে, যেকোনো নিয়ম $X \rightarrow Y$ বৈধ হবে যদি নিচের **যেকোনো একটি** শর্ত পূরণ হয়:
  - **শর্ত ১ (বাম পাশ)**: $X$ একটি সুপার কী হতে হবে। (অথবা)
  - **শর্ত ২ (ডান পাশ)**: $Y$ একটি Prime Attribute (চাবির অংশ) হতে হবে।
