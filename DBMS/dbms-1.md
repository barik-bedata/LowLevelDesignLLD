...
##### ⚠️ 3NF ভায়োলেট করার ফলে সৃষ্ট ডাটাবেস অ্যানোমালি (Database Anomalies):
এই Transitive Dependency-এর কারণে ডাটাবেসে ৩টি বড় সমস্যা (Anomalies) তৈরি হয়:
1. **Update Anomaly (আপডেট করার সমস্যা):** যদি "IT" ডিপার্টমেন্টের নাম পরিবর্তন করে "Tech" রাখা হয়, তবে টেবিলে যতজন IT ডিপার্টমেন্টের এমপ্লয়ি আছে (এখানে ২ জন, বাস্তবে হয়তো হাজার জন), সবার রো-তে গিয়ে আলাদাভাবে "IT" কেটে "Tech" লিখতে হবে। একটা মিস হলে ডাটাবেসে ভুল তথ্য (Inconsistency) থেকে যাবে।
2. **Insert Anomaly (যুক্ত করার সমস্যা):** ধরুন কোম্পানিতে নতুন একটি ডিপার্টমেন্ট খোলা হলো "Sales" (D03), কিন্তু এখনো কোনো এমপ্লয়ি নিয়োগ দেওয়া হয়নি। আপনি এই টেবিলে "Sales" ডিপার্টমেন্টের তথ্য ইনসার্ট করতে পারবেন না! কারণ `emp_id` হলো Primary Key যা ফাঁকা (NULL) রাখা যায় না।
3. **Delete Anomaly (মুছে ফেলার সমস্যা):** যদি রহিম (E01) চাকরি ছেড়ে দেয় এবং আমরা তার রো-টি মুছে ফেলি, তাহলে রহিমের তথ্যের সাথে সাথে "HR (D01)" ডিপার্টমেন্টের অস্তিত্বই ডাটাবেস থেকে চিরতরে মুছে যাবে!
